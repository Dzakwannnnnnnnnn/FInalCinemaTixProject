    ...
    <div class="container-fluid p-4" style="margin-left: 280px;">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p class="text-muted mb-0">Buat jadwal tayang untuk film</p>
        </div>
        <div class="text-end">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="form-container">
            <form action="index.php?controller=admin&action=addJadwal" method="POST">
              <div class="row">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="harga_tiket" name="harga_tiket" min="0" step="1000"
