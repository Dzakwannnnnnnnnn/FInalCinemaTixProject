...
<head>
  <meta charset="UTF-8">
  <title>Tambah Berita - Admin CinemaTix</title>
    ...
    <div class="container-fluid p-4" style="margin-left: 280px;">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p class="text-muted mb-0">Tambah berita atau event baru</p>
        </div>
        <div class="text-end">
        ...
        <div class="col-md-8">
          <div class="card shadow-sm">
            <div class="card-body p-4">
              <form action="index.php?controller=admin&action=addNews" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                  <label for="judul_news" class="form-label fw-semibold">Judul Berita *</label>
                  <input type="text" class="form-control" id="judul_news" name="judul_news" required>
                </div>

                <div class="mb-3">
                  <label for="deskripsi_news" class="form-label fw-semibold">Deskripsi Berita *</label>
                  <textarea class="form-control" id="deskripsi_news" name="deskripsi_news" rows="6" required></textarea>
                </div>

                <div class="mb-4">
                  <label for="foto_news" class="form-label fw-semibold">Foto Berita</label>
