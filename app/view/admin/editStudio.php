...
<head>
  <meta charset="UTF-8">
  <title>Edit Studio - Admin CinemaTix</title>
    ...
    <div class="container-fluid p-4" style="margin-left: 280px;">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p class="text-muted mb-0">Edit data studio CinemaTix</p>
        </div>
        <div class="text-end">
        ...
        <div class="col-md-8">
          <div class="card shadow-sm">
            <div class="card-body p-4">
              <form action="index.php?controller=admin&action=editStudio&id=<?= $studio['studio_id'] ?>" method="POST">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nama_studio" name="nama_studio"
                    value="<?= htmlspecialchars($studio['nama_studio']) ?>" required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" id="tipe" name="tipe" required>
                    ...
                    <option value="2D" <?= $studio['tipe'] === '2D' ? 'selected' : '' ?>>2D</option>
                    <option value="3D" <?= $studio['tipe'] === '3D' ? 'selected' : '' ?>>3D</option>
                    <option value="IMAX" <?= $studio['tipe'] === 'IMAX' ? 'selected' : '' ?>>IMAX</option>
                    <option value="4DX" <?= $studio['tipe'] === '4DX' ? 'selected' : '' ?>>4DX
                    </option>
                  </select>
                </div>
                ...
                <div class="mb-4">
                  ...
                  <input type="number" class="form-control" id="kapasitas" name="kapasitas"
                    value="<?= htmlspecialchars($studio['kapasitas']) ?>" min="1" required>
                </div>

                <div class="d-grid">
                  <button type="submit" class="btn btn-primary btn-lg">
                    <i class="bi bi-pencil-square"></i> Update Studio
                  </button>
                </div>
              </form>
            </div>
