...
error_log("View Payment Data for ID: " . ($payment['pembayaran_id'] ?? 'unknown'));
error_log("Payment Status: " . ($payment['status'] ?? 'unknown'));
error_log("Full Payment Data: " . print_r($payment, true));
?>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <p><strong>Payment Date:</strong> <?= htmlspecialchars($payment['tanggal_pembayaran'] ?? 'N/A') ?></p>
          </div>
          <div class="col-md-6">
            <h6>Payment Details</h6>
            <p><strong>Payment Method:</strong> <?= htmlspecialchars($payment['nama_method'] ?? 'N/A') ?></p>
            <p><strong>Amount:</strong> Rp <?= isset($payment['jumlah']) ? number_format($payment['jumlah'], 0, ',', '.') : 'N/A' ?></p>
